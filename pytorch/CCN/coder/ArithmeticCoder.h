...
protected: virtual void update(const uint32_t * table, const uint32_t ncode, const uint32_t sum, std::uint32_t symbol);
...
public: std::uint32_t read(const uint32_t* table, const uint32_t ncode, const uint32_t sum);
...
public: void write(const uint32_t* table, const uint32_t ncode, const uint32_t sum, std::uint32_t symbol);
