Run the install.bat under the CCN folder to install the CCN package and install.bat under the coder folder to install the arithmetic coder under windows. For Linux, just run "python setup.py install". 
