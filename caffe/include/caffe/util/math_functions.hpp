...
template <typename Dtype>
void caffe_cpu_clip(const int n, const Dtype clip, Dtype* X);
...
void caffe_gpu_gemm(const CBLAS_TRANSPOSE TransA,
    ...
    Dtype* C);
template <typename Dtype>
void caffe_gpu_gemm_with_handle(cublasHandle_t handle, const CBLAS_TRANSPOSE TransA,
	const CBLAS_TRANSPOSE TransB, const int M, const int N, const int K,
	const Dtype alpha, const Dtype* A, const Dtype* B, const Dtype beta,
	Dtype* C);
template <typename Dtype>
...
void caffe_gpu_gemm_batch(const CBLAS_TRANSPOSE TransA,
	const CBLAS_TRANSPOSE TransB, const int M, const int N, const int K,
	const Dtype alpha, const Dtype* A, const Dtype* B, const Dtype beta,
	Dtype* C,const int strideA,const int strideB, const int strideC,const int batch, const int lda, const int ldb);
template <typename Dtype>
void caffe_cpu_gemm_batch(const CBLAS_TRANSPOSE TransA,
	...
	Dtype* C, const int strideA, const int strideB, const int strideC, const int batch, const int lda, const int ldb);
template <typename Dtype>
void caffe_gpu_gemm_batch2(const CBLAS_TRANSPOSE TransA,
	const CBLAS_TRANSPOSE TransB, const int M, const int N, const int K,
	const Dtype alpha, const Dtype* A, const Dtype* B, const Dtype beta,
	Dtype* C, const int strideA, const int strideB, const int strideC, const int batch);
template <typename Dtype>
...
template <typename Dtype>
void caffe_gpu_clip(const int N, const Dtype clip, Dtype *X);
